<?php
function gavias_megaland_base_url(){
  global $base_url;
  $theme_path = drupal_get_path('theme', 'gavias_megaland');
  return $base_url . '/' . $theme_path . '/';
}

function gavias_megaland_preprocess_node(&$variables) {
...
function gavias_megaland_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function gavias_megaland_preprocess_node__gallery(&$variables){
  $variables['#attached']['library'][] = 'gavias_megaland/gavias_megaland.gallery';
}


function gavias_megaland_preprocess_breadcrumb(&$variables){
